...
fig_name = "CREMAD_all_classes_corrected_rer.jpg"
fig_name_1 = "CREMAD_all_classes_corrected_diff.jpg"
...
labels_path = "../prep_features_classification/cremad/correct_labels.npy"
features_path = "../prep_features_classification/cremad/"
...
#Input labels have a different order
input_labels_path = "../prep_features_classification/cremad/input_layer_labels.npy"

input_labels = np.load(input_labels_path)

y_input = np.array([dic[str(i)] for i in input_labels])
