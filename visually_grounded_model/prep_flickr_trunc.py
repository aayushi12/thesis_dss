...
audio_path = os.path.join(os.getcwd(),'data/databases/flickr/flickr_audio/wavs')
img_path = os.path.join(os.getcwd(),'data/databases/flickr/Flickr8k_Dataset/Flicker8k_Dataset')
text_path = os.path.join(os.getcwd(),'data/databases/flickr/dataset.json')
# save the resulting feature file here
data_loc = os.path.join(os.getcwd(),'prep_data_trunc/flickr_features.h5')
...
for ftype in speech:
    params[4] = ftype #made a change here, in the original code they have written x
