...
#Modified: trainer.save_params



from minibatchers_modified import iterate_tokens_5fold, iterate_char_5fold, iterate_audio_5fold
...
######################## evaluation functions #################################
    ...
    def save_params(self, loc):
        ...
        torch.save({'epoch': self.epoch,'loss': self.loss, 'audio_batcher': self.batcher,"att_loss":self.att_loss, "scheduler": self.scheduler , "train_loss": self.train_loss, "iteration": self.iteration }, os.path.join(loc, 'other_params' + '.' +str(self.epoch)))
