...
#3 files are skipped
#['OAF_bite_neutral.wav', 'YAF_germ_angry.wav', 'YAF_neat_fear.wav']
# Name corrected for first. 2 remaining files seem to be corrupted. Will try fix_wav on them
...
#Files skipped : ['YAF_germ_angry.wav', 'YAF_neat_fear.wav']
#Checked the website.These are corrupted. Better to skip them   
#2798 observations      
