...
def audio_features (params, audio_path, append_name, node_list):
    ...
    for node in node_list:
        ...
        base_name_1 = base_name.split("_")
        actor = base_name_1[-1]
        base_name_1 = "-".join(base_name_1)
        audio_file = base_name_1 + ".wav"
        
        audio_folder = "Actor_" + actor
...
data_loc = os.path.join(os.getcwd(),'prep_data/ravdess_features.h5')
audio_path = os.path.join(os.getcwd(),'ravdess-emotional-speech-audio')

#Create node names for all the audio files for this dataset

node_names = []
dic = load_obj('ravdess_info')

for obs in dic:
    feature_dic = dic[obs]
    lis = [str(feature_dic[x]) for x in feature_dic]
    
    name = "03_01_" + "_".join(lis)
    node_names.append(name)

append_name = 'ravdess_'
...
import h5py
f = h5py.File('prep_data/ravdess_features.h5', 'r')

len(list(f.keys())) #1400
...
#Picking one node
for elem in f['ravdess_03_01_08_02_02_02_24']:
    print(elem)
    
# Each node has four sub groups - fbanks, freq_spectrum, mfcc, raw
    
for x in f['ravdess_03_01_08_02_02_02_24/mfcc']:
    print(x)       

# Now mfcc contains one group - which is basically the corresponding example
    
for y in f['ravdess_03_01_08_02_02_02_24/mfcc/ravdess_03_01_08_02_02_02_24']:
    print(y.shape) #(39,)   
    print(type(y)) #numpy.ndarray
    
len([y for y in f['ravdess_03_01_08_02_02_02_24/mfcc/ravdess_03_01_08_02_02_02_24']]) #363 
  
#Trying some other node

for elem in f['ravdess_03_01_01_01_01_01_01']:
    print(elem)
    

for x in f['ravdess_03_01_01_01_01_01_01/mfcc']:
    print(x)       


for y in f['ravdess_03_01_01_01_01_01_01/mfcc/ravdess_03_01_01_01_01_01_01']:
    print(y.shape) #(39,)   
    print(type(y)) #numpy.ndarray
    
len([y for y in f['ravdess_03_01_01_01_01_01_01/mfcc/ravdess_03_01_01_01_01_01_01']]) #330
...
labels_loc = os.path.join(os.getcwd(),'prep_data/labels.txt')   
