...
for batch in batches:
    ...
    for example in batch:
        ...
        labels.append(example.split("_")[3])
...
print(len(targets))
np.save('cremad/' + 'correct_labels.npy',targets)

print(feature_matrix[-1,:])
np.save('cremad/' + 'activations_attention_cremad.npy',feature_matrix)
f.close()
...
print(feature_matrix[-1,:])
np.save('cremad/' + 'activations_rnn_3_cremad.npy',feature_matrix)
f.close()
...
print(feature_matrix[-1,:])
np.save('cremad/' + 'activations_rnn_2_cremad.npy',feature_matrix)
f.close()
...
np.save('cremad/' + 'activations_rnn_1_cremad.npy',feature_matrix)
f.close()
...
np.save('cremad/' + 'activations_conv_norm_cremad.npy',feature_matrix)
f.close()
...
np.save('cremad/' + "Average_MFCC_norm_cremad.npy",feature_matrix)

print(feature_matrix[-1,:])
print(len(labels))
print(np.unique(labels, return_counts = True))

np.save('cremad/' + 'input_layer_labels.npy',labels)
...
for example in f:
    intensity.append(example.split("_")[-1])
    
counts = np.unique(intensity, return_counts = True)[1]
counts[-1]/np.sum(counts)
'''
#%%

#Getting randomly initialised untrained activations
...
print(feature_matrix[-1,:])
np.save('cremad/' + 'untrained_' + 'activations_attention_cremad.npy',feature_matrix)
...
print(feature_matrix[-1,:])
np.save('cremad/' + 'untrained_'+ 'activations_rnn_3_cremad.npy',feature_matrix)
...
print(feature_matrix[-1,:])
np.save('cremad/' + 'untrained_' + 'activations_rnn_2_cremad.npy',feature_matrix)
...
np.save('cremad/' + 'untrained_' + 'activations_rnn_1_cremad.npy',feature_matrix)
...
np.save('cremad/' + 'untrained_' + 'activations_conv_norm_cremad.npy',feature_matrix)
f.close()
