...
print(feature_matrix[-1,:])
np.save('tess/' + 'untrained_' + 'activations_attention_tess.npy',feature_matrix)
...
print(feature_matrix[-1,:])
np.save('tess/' + 'untrained_'+ 'activations_rnn_3_tess.npy',feature_matrix)
...
print(feature_matrix[-1,:])
np.save('tess/' + 'untrained_' + 'activations_rnn_2_tess.npy',feature_matrix)
...
np.save('tess/' + 'untrained_' + 'activations_rnn_1_tess.npy',feature_matrix)
...
np.save('tess/' + 'untrained_' + 'activations_conv_norm_tess.npy',feature_matrix)
f.close()
