...
print(feature_matrix[-1,:])
np.save('ravdess/' + 'untrained_' + 'activations_attention_ravdess.npy',feature_matrix)
...
print(feature_matrix[-1,:])
np.save('ravdess/' + 'untrained_'+ 'activations_rnn_3_ravdess.npy',feature_matrix)
...
print(feature_matrix[-1,:])
np.save('ravdess/' + 'untrained_' + 'activations_rnn_2_ravdess.npy',feature_matrix)
...
np.save('ravdess/' + 'untrained_' + 'activations_rnn_1_ravdess.npy',feature_matrix)
...
np.save('ravdess/' + 'untrained_' + 'activations_conv_norm_ravdess.npy',feature_matrix)
f.close()
